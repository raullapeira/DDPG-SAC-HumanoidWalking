...
_CSV_PATH = os.path.join(_HERE, "training_log_v2.csv")

# Carpeta de media para esta sesion de training
_TODAY     = datetime.date.today().strftime("%d_%m_%Y")
_MEDIA_DIR = os.path.join(_HERE, "media", f"{_TODAY}_v13_cog_x2")
...
writer = SummaryWriter("runs_v2/sac_alpha_v2")
...
# ---- Resume from latest v2 checkpoint if one exists ----
_ckpts = sorted(
